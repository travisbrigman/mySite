...
struct MainController: RouteCollection {
    ...
    func projects(req: Request) async throws -> View {
        let cards = [
            ...
            Card(
                ...
                imagePath: "/images/portfolio/UXCOE.png",
            ...
            Card(
                title: "Seat Geek",
                description: "This started off as a code challenge and I am proud of the results.",
    ...
    func projectDetail(req: Request) async throws -> View {
        let projectDetails = [
            DetailContext(name: "seat-geek", title: "Seat Geek", description: "This is a code challenge I did for a company called FetchNow. It consumes a list of events from the SeatGeek API and displays them in a list. A user can tap a list item and see a detail view of that item. The user can like the event in the detail view and see liked events back in the table view. The likes persist even if the app is closed.", imageURL: "/images/portfolio/SeatGeek-1.png", liveSite: nil, gitHubRepo: "https://github.com/travisbrigman/FetchNow"),
